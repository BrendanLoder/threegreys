export default function Tailwind() {
    return (
        ...
        <div className="bg-indigo-700 px-4 py-3 flex justify-center border-b-4 border-pink-500 w-full">
            <div>
                ...
                <div className="my-4">
                    ...
                    <div className="relative mt-4 flex">
                        <div>
                            <a href="#" className="bg-pink-500 text-indigo-100 font-bold mt-2 px-4 py-2 rounded-full text-xs uppercase">Enroll Now</a>
                        </div>
        ...
        <div className="mt-16 w-full flex flex-col items-center content_center">
            ...
            <div className="max-w-4xl mx-4">
                ...
                <div className="mt-8 pb-1 font-bold text-xl text-indigo-700 border-b border-indigo-600">Advantages</div>
