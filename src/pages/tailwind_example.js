export default function Tailwind() {
    return (
        <>
            ...
            <header class="bg-indigo-700 w-full px-4 py-3">
                ...
                <div class="max-w-4xl w-full">
                    ...
                    <div class="m-y-4">
                        ...
                        <p class="text-xs text-indigo-200">Tailwind is the fastest growing utility-first CSS framework. Let's learn it step by step.</p>
                        ...
                        <div class="relative  mt-4">
                            ...
                            <div class="absolute right=0bg-white rounded-full flex justify-center items-center p-5 border-4 border-pink-500">
            ...
            <footer>
                ...
                <p class="text-sm text-gray-400">Copyright © 2022 ThreeGrays</p>
